...
INSERT INTO `task` VALUES (1,'Clean around counters','Cleaning up around the counters so counters can be removed',1,3,1),(2,'Vacuum closet','Vacuum closet so it is free of debris for remodel',2,5,2);
...
-- Dump completed on 2014-06-17 14:06:19
